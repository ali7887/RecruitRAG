  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-6 py-10">
      <div className="flex flex-col items-start gap-3 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
        <h1 className="text-lg font-semibold text-zinc-100">Couldn’t load this candidate</h1>
        <p className="text-sm text-zinc-400">
          Something went wrong while loading the candidate. This is usually temporary.
        </p>
        <button
          onClick={reset}
